...
describe('HawkularDatasource annotations', function () {
  var ctx = {};
  ...
  it('should query annotations without tags', function (done) {
    ...
    ctx.backendSrv.datasourceRequest = function (request) {
      (0, _testUtil.expectRequest)(request, 'POST', 'strings/raw/query');
  ...
  it('should query annotations from avails', function (done) {
  ...
  it('should query annotations from alerts', function (done) {
    ...
    ctx.backendSrv.datasourceRequest = function (request) {
      (0, _testUtil.expectAlertRequest)(request, 'GET', 'events');
...
//# sourceMappingURL=datasource-annotations_spec.js.map
