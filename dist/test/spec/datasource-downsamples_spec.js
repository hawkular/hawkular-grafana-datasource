...
describe('HawkularDatasource for downsamples', function () {
  var ctx = {};
  ...
  it('should query summed stats avg and percentile', function (done) {
    var options = {
      range: {
        from: 20,
        to: 30
  ...
  it('should query unmerged stats min and percentile', function (done) {
    var options = {
      range: {
        from: 20,
        to: 30
    ...
    ctx.backendSrv.datasourceRequest = function (request) {
      (0, _testUtil.expectRequest)(request, 'POST', 'metrics/stats/query');
      expect(request.data).to.deep.equal({
        start: options.range.from,
        end: options.range.to,
        tags: 'type:memory',
...
//# sourceMappingURL=datasource-downsamples_spec.js.map
